...
## Summary
- 143 nodes · 319 edges · 15 communities detected
...
Cohesion: 0.3
Nodes (10): count_by(), evidence_rank(), is_auxiliary_evidence(), main(), parse_args(), post_json(), progress(), run_gemini_batches() (+2 more)

### Community 4 - "Community 4"
Cohesion: 0.33
Nodes (11): $(), addEntryRow(), applySelectedCandidate(), renderEmployeeResults(), renderEntities(), renderEntryRows(), searchEmployees(), selectedEntryRow() (+3 more)
...
Cohesion: 0.43
Nodes (7): applyEmployeeToRow(), candidateLabel(), makeRowKey(), renderEntryRow(), renderJobGroupOptions(), rowField(), rowValue()
...
- **Why does `import_run()` connect `Community 0` to `Community 1`, `Community 13`, `Community 6`?**
  _High betweenness centrality (0.174) - this node is a cross-community bridge._
- **Why does `run_reply_import()` connect `Community 0` to `Community 3`?**
