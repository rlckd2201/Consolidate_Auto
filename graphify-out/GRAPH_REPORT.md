...
- `renderReviewRows()` --calls--> `$()`  [EXTRACTED]
...
Cohesion: 0.4
Nodes (5): $(), addEntryRow(), renderEntities(), renderEntryRows(), renderSubmissionSelect()

### Community 6 - "Community 6"
Cohesion: 0.4
Nodes (5): flattenRows(), fmtCount(), loadBootstrap(), renderBars(), renderReviewRows()
