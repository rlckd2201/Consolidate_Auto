...
## Summary
- 137 nodes · 308 edges · 16 communities detected
...
Cohesion: 0.21
Nodes (16): apply_master_updates(), create_submission(), fill_approval_draft_stub(), LegalEntity, load_state(), _now(), OvertimeRow, Period (+8 more)

### Community 2 - "Community 2"
Cohesion: 0.21
Nodes (10): choose_template(), classify_hr_employee(), copy_template_output(), display_factory_from_hr(), entity_code_from_hr(), export_excel_stub(), export_ppt_stub(), hr_candidate_from_row() (+2 more)
...
Cohesion: 0.28
Nodes (9): analyze_evidence_with_gemini(), build_gemini_prompt(), call_gemini_json(), gemini_analysis_schema(), GeminiEvidenceAnalyzeRequest, GeminiEvidenceItem, import_run(), run_gemini_import_batches() (+1 more)
...
Cohesion: 0.48
Nodes (6): save_run(), main(), parse_args(), post_json(), run_gemini_batches(), select_ai_evidence()
...
- **Thin community `Community 15`** (2 nodes): `__init__.py`, `Overtime reporting web backend.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `import_run()` connect `Community 4` to `Community 0`, `Community 8`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `run_reply_import()` connect `Community 0` to `Community 8`, `Community 4`?**
